...
leaflet(grade_diff_by_county_with_breaks_geo) %>%
  ...
  addLegend(colors = met.brewer(palname,3)[1:3], values = ~grade_diff_cat, title = NULL, labels = c('1-2 grades lower than national average', 'Less than 1 grade lower than average', '0-1 grade higher than national average'))
